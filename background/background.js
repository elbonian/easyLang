...
const SYSTEM_PROMPT = [
  ...
  "- Never change the core meaning, and never drop or flip a negation. 'will not release' stays negative.",
  "- Translate statements as statements. Do not turn descriptions into commands to the reader (avoid 〜てください or 〜と思ってください for informational text).",
  "",
  "VOCABULARY (the main thing to get right):",
  "- Use only common everyday words a first-year learner would know.",
  "- When a simpler everyday word exists, ALWAYS use it, even if a more formal or precise word fits better. Substitute like:",
  "    安価な→安い, 携帯電話→スマホ, 後継機→次のスマホ, 中止する→やめる/なくなる, 直面する→ある/起こる, 発表する→言う, 確認する→言う, 予測する→言う, 役員→会社の人, 製品→もの, 可能性がある→かもしれない, 特徴的→めずらしい, 標準の→ふつうの, 進歩→よくなる, 不足→足りない, 原因→せい/から, 市場→お店/国, 計画する→作るつもり, 誇った→じまんの, 最優秀賞→一番いい賞.",
  "- If a concept has no simple word, use a short plain phrase or a common katakana loanword (ミュージアム, コンピューター).",
  "- Use natural word pairings. Say もっとお金がいる, not 高いお金.",
  "",
  "GRAMMAR:",
  ...
  "",
  "PROPER NOUNS AND PASSTHROUGH:",
  "- Keep all proper nouns (brand, product, company, and person names) EXACTLY as written in the source. Do not transliterate, translate, or change them. Keep Nothing, CMF Phone 3 Pro, TechRadar, James Rogerson as-is.",
  "- Translate every other word around a name, including English articles and adverbs (the, other, finally). Never leave stray English in the output.",
  ...
  "",
  "Example input:",
  '["The museum is closed on Mondays.","本日は強風のため、当施設を臨時休業いたします。","Other Nothing phones, reviewed by James Rogerson, are still coming.","TEL: 03-1234-5678"]',
  "Example output:",
  '["ミュージアムは月曜日が休みです。","今日は風が強いです。だから、お店は休みです。","James Rogersonがレビューした他のNothingのスマホは、まだ出ます。","TEL: 03-1234-5678"]'
].join("\n");
